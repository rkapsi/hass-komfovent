...
class C4(Register):
    ...
    MONTH_DAY                   = (1004, Datatype.uint16, Access.READ_WRITE)
...
REGISTERS_APPLY_EMA = {
    ...
    C6.REG_PANEL2_RH,
    C6.REG_EXHAUST_TEMP,
    C6.REG_HEAT_EXCHANGER,
    C6.REG_HEAT_RECOVERY,
    C6.REG_HEAT_EFFICIENCY,
    C6.REG_SUPPLY_PRESSURE,
    C6.REG_EXTRACT_PRESSURE,
    C6.REG_INDOOR_ABS_HUMIDITY,
    C6.REG_OUTDOOR_ABS_HUMIDITY,
    C6.REG_EXTRACT_AQ_1,
    C6.REG_EXTRACT_AQ_2,
    C6.REG_SPI,
    C6.REG_ENERGY_SAVING,
}
